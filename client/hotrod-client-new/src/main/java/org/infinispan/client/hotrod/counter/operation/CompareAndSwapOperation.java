...
public class CompareAndSwapOperation extends BaseCounterOperation<Long> {
   ...
   public CompareAndSwapOperation(InternalRemoteCache<?, ?> remoteCache, String counterName, long expect, long update, CounterConfiguration counterConfiguration) {
      super(remoteCache, counterName, true);
      this.expect = expect;
      this.update = update;
