 ...
 * @since 9.2
 */
abstract class BaseCounterOperation<T> extends AbstractCacheOperation<T> {
   ...
   BaseCounterOperation(InternalRemoteCache<?, ?> remoteCache, String counterName, boolean useConsistentHash) {
      super(remoteCache);
