...
public class RemoteCounterManager implements CounterManager {
   ...
   public void start(InternalRemoteCache<?, ?> remoteCache, OperationDispatcher dispatcher, ClientListenerNotifier listenerNotifier) {
      this.factory = new CounterOperationFactory(remoteCache);
      this.dispatcher = dispatcher;
      this.notificationManager = new NotificationManager(listenerNotifier, factory, remoteCache.getDispatcher());
   }
