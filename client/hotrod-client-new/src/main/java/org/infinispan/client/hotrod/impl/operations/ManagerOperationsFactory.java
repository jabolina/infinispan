...
public class ManagerOperationsFactory {
   ...
   /**
    * A single ping operation, used normally to test a very specific server. This command is not retried and will
    * immediately propagate any errors.
    * @return
    */
   public HotRodOperation<PingResponse> newPingOperation() {
      return new NoCachePingOperation();
   }
   ...
   public HotRodOperation<String> executeOperation(String taskName, Map<String, byte[]> marshalledParams, Object key) {
