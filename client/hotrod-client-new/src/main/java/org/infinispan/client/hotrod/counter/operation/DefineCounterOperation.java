...
public class DefineCounterOperation extends BaseCounterOperation<Boolean> {
   ...
   public DefineCounterOperation(InternalRemoteCache<?, ?>  remoteCache, String counterName, CounterConfiguration configuration) {
      super(remoteCache, counterName, false);
